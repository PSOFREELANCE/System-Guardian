...
We as members, contributors, and leaders of the **System Guardian** project
...
- Being **patient** with newcomers and those less experienced
- Offering **helpful, actionable** feedback on code reviews
...
- The GitHub repository (issues, PRs, discussions, code review, wiki)
- Any project-related chat channels (Discord, Matrix, Slack, etc.)
- Social media when representing the project
- In-person or virtual events, meetups, and conferences
- Private communications between community members when related to project work

It also applies when an individual is **officially representing the project**
in public spaces. Examples of representing our project include using an official
...
- A description of the incident(s), including dates/times if known
- Links, screenshots, or other evidence if available
- Any additional context that will help us understand the situation

### Our commitments

- **All community leaders** are obligated to respect the privacy and security
  of the reporter of any incident.
- **Retaliation** against anyone who reports an incident in good faith is
  strictly prohibited and will result in enforcement action.
- We will **keep you informed** of the status of your report.
- Reports will be handled with **confidentiality** to the extent possible.
